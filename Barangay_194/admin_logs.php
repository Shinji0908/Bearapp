...
// Fetch logs
$sql_logs = "
    SELECT al.*, a.first_name AS admin_name, rp.first_name AS resident_name
    FROM AdminLogs al
    INNER JOIN Admins a ON al.admin_id = a.user_id
    INNER JOIN ResidentProfiles rp ON al.user_id = rp.user_id
